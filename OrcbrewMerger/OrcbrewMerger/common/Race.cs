...
namespace OrcbrewMerger.common
{
    public class Race
    {
        ...
        public enum eRaceSize { Small, Medium, Large};
        public enum eRaceSpeed { TwentyFive, Thirty, ThirtyFive};
        public enum eRaceDarkvision { Zero, Sixty, OneTwenty };
        public enum eStatIncrease { MinusTwo, MinusOne, Zero, One, Two};

        public eRaceSize raceSize = eRaceSize.Medium;
        public eRaceSpeed raceSpeed = eRaceSpeed.Thirty;
        public eRaceSpeed raceFlyingSpeed = eRaceSpeed.Thirty;
        public eRaceSpeed raceSwimmingSpeed = eRaceSpeed.Thirty;
        public eRaceDarkvision raceDarkvision = eRaceDarkvision.Zero;

        public eStatIncrease increaseStrength = eStatIncrease.Zero;
        public eStatIncrease increaseConstitution = eStatIncrease.Zero;
        public eStatIncrease increaseDexterity = eStatIncrease.Zero;
        public eStatIncrease increaseIntelligence = eStatIncrease.Zero;
        public eStatIncrease increaseWisdom = eStatIncrease.Zero;
        public eStatIncrease increaseCharisma = eStatIncrease.Zero;

        public bool armorClassThirteenPlusDex = false;
        public bool armorClassSeventeen = false;
        ...
        public Race(string Key, string Name, string OptionPack)
        {
            key = Key;
            name = Name;
